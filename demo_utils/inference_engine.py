...
def engine_factory(api_key=None, model=None, **kwargs):
    ...
    elif model in ["gemini-1.5-pro-latest", "gemini-1.5-flash", "gemini-2.0-flash-exp"]:
        if api_key and api_key != EMPTY_API_KEY:
    ...
    raise Exception(f"Unsupported model: {model}, currently supported models: \
                    gpt-4-vision-preview, gpt-4-turbo, gpt-4o, , gpt-4o-mini, gemini-1.5-pro-latest, llava, gemini-2.0-flash-exp")
